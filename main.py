...
def combo_callback(choice):
     print(choice)   ## The choice needs to be changed to one of the YTobject.streams.<resolution type>
    
comboBox = customtkinter.CTkComboBox(master=app, values=["Video 1080p",
                                                         "Video 720p",
                                                         "Video 360p",
                                                         "Audio 160kbps",
                                                         "Audio 70kbps"],
                                                         command=combo_callback) #The options need to refer back to the Download 
comboBox.pack(padx=20, pady=20)
comboBox.set("Resolution")
...
##### There should be --ONE-- Download Button because the option is selected on line 81-84
...
##### For v2 Change Resolution to Specific

##### For v2 Pin Thumbnail in app before downloading

##### For v2 List Video name when inputting link